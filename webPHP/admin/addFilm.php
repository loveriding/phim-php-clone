            ...
            <div class="container" id="post_film" style="padding: 0 15%">
                ...
                <form method="post" id="form-insert-film" name="form-insert-film" class="form-horizontal" action="" role="form" >
                    ...
                    <div>
                        ...
                        <div class="col-md-9">
                            <input type="number" name="year" id="year" min="1990" max="<?php $now = getdate();$now["year"]=$now["year"]+5; echo $now["year"];?>" style="color: black"></input>
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div class="col-md-9">
                            <input type="number" class="form-control" id="duration" min="0" max="1000" name="duration">
                        </div>
                    </div>
                    <div>
