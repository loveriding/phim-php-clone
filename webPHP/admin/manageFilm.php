                ...
                <form method="post">
                    <div class="row">
                       <div class="col-md-1"></div>
                        <div class="col-md-7">
                            <input class="form-control form-control-lg form-control-borderless" type="search" placeholder="Search film for name, director, actor,..." name="qry" value=<?php $qry = isset($_POST["qry"]) ? $_POST["qry"] : ''; echo $qry;  ?>>
                        </div>
                        <div class="col-md-4">
