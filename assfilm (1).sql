...
-- Thời gian đã tạo: Th12 28, 2019 lúc 09:09 AM
...
DROP TABLE IF EXISTS `nav-menu`;
CREATE TABLE IF NOT EXISTS `nav-menu` (
...
DROP TABLE IF EXISTS `series-movie`;
CREATE TABLE IF NOT EXISTS `series-movie` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 NOT NULL,
...
DROP TABLE IF EXISTS `single-movie`;
CREATE TABLE IF NOT EXISTS `single-movie` (
...
DROP TABLE IF EXISTS `theater-movie`;
...
DROP TABLE IF EXISTS `type-movie`;
CREATE TABLE IF NOT EXISTS `type-movie` (
...
(1, 'admin123', '', '$2y$10$u7.DPinN7JuTKFX7UeuI3.VpmfGxWcY2LxWBsZdAe1Ims0HKeMkBa', '', '2018-11-13', 'female', 99),
(4, 'admin', '', '$2y$10$.WPG8HgyBGyKnn2TEFk52eEpeM2cBfP9UU6I/C0BodpWGBCovRfPe', 'quangvo33@gmail.com', '2018-11-04', 'male', 99),
